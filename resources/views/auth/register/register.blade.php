...
<body style="background-color:#ECF1F6;">
  <form action="{{ route('registerPost') }}" method="POST">
    <div class="w-100 vh-100 d-flex" style="align-items:center; justify-content:center;">
      <div class="w-25 vh-75 border form-style" style="padding:3rem;">
        ...
        <div class="mt-3">
            ...
            @if($errors->has('correct_days'))
              <div class="error_message">
                @foreach ($errors->get('correct_days') as $error)
                  {{ $error }}<br>
                @endforeach
              </div>
            @endif
          ...
          <div class="birth">
            <div class="border-bottom border-primary" style="display:inline-block; width:25%;">
              <select class="border-0 old_year" name="old_year" style="width:105%;">
              ...
              <label style="font-size:13px; margin-left:-5%;">年</label>
            <div class="border-bottom border-primary" style="display:inline-block; width:25%;">
              <select class="border-0 old_month" name="old_month" style="width:105%;">
                <option value="none">-----</option>
              ...
              <label style="font-size:13px; margin-left:-5%;">月</label>
            <div class="border-bottom border-primary" style="display:inline-block; width:25%;">
              <select class="border-0 old_day" name="old_day" style="width:105%;">
                <option value="none">-----</option>
                <option value="01">1</option>
                <option value="02">2</option>
                <option value="03">3</option>
              ...
              <label style="font-size:13px; margin-left:-5%;">日</label>
          </div>
        </div>
        <div class="mt-3">
            @if($errors->has('role'))
